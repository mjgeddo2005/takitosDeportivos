            ...
            <View style={styles.imageProfileContainer}>
                {
                    image
                        ...
                        :
                        <MonserratRText style={styles.textProfilePlaceHolder}>{user.charAt(0).toUpperCase()}</MonserratRText>
                }
                <Pressable onPress={pickImage} style={({ pressed }) => [{ opacity: pressed ? 0.90 : 1 }, styles.cameraIcon]} >
                    <CameraIcon />
                </Pressable>
            </View>
            <MonserratRText style={styles.profileData}>Email: {user} </MonserratRText>
            <View style={styles.mapContainer}>
                {
                    location
                        ...
                        >
                            <Marker coordinate={{ "latitude": location.coords.latitude, "longitude": location.coords.longitude }} title={"Takitos Deportivos"} />
                        </MapView>
                        :
                        (
                            locationLoaded
                                ?
                                <MonserratRText>Hubo un problema al obtener la ubicación</MonserratRText>
                                :
                                <ActivityIndicator />
                        )
                ...
                <View style={styles.placeDescriptionContainer}>
                    <View style={styles.addressContainer}>
                        <MonserratRText>Dirección:</MonserratRText>
                        <MonserratRText style={styles.address}>{address || ""}</MonserratRText>
                    </View>
                </View>
            </View>
            <View style={styles.placeDescriptionContainer}>
